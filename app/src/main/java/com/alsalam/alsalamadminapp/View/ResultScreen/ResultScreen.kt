package com.alsalam.alsalamadminapp.View.ResultScreen
...
fun ResultScreen(){
    ...
    Scaffold(
        topBar = { CustomTopBar(text = "Results") }
    ) {
        ...
        LazyColumn(
            ...
            item {
                ...
                Card(
                    modifier = Modifier
                        ...
                        .clickable {
                            ...
                            Toast.makeText(context, "Results selected", Toast.LENGTH_SHORT)
                                .show()
                        },
                ...
                SaveUploadButton(title = "Upload", onClick = {
                    uploadNoticesViewModel.uploadResultPdf()
