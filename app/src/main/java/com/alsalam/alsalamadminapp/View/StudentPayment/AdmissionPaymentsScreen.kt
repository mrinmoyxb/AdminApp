...
@Composable
fun AdmissionPaymentScreen(navController: NavController, adminApprovePaymentViewModel: AdminApprovePaymentViewModel){
    ...
    Scaffold(
        topBar = { CustomTopBar(text = "Admission Payments") }
    ){
