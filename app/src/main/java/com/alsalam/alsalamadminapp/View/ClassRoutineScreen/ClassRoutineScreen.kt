package com.alsalam.alsalamadminapp.View.ClassRoutineScreen
        ...
        LazyColumn(
            ...
            item {
                ...
                Card(
                    modifier = Modifier
                        ...
                        .clickable {
                            ...
                            Toast
                                .makeText(context, "Class Routine selected", Toast.LENGTH_SHORT)
                                .show()
                        },
                ...
                SaveUploadButton(title = "Upload", onClick = {
                    uploadNoticesViewModel.uploadClassRoutinePdf()
                    Toast.makeText(context, "Class Routine Uploaded", Toast.LENGTH_SHORT).show()
                })
            }
        }
    }
