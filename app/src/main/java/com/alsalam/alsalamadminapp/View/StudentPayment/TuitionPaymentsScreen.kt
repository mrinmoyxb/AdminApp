...
@Composable
fun TuitionPaymentScreen(navController: NavController, adminApprovePaymentViewModel: AdminApprovePaymentViewModel){
    ...
    Scaffold(
        topBar = { CustomTopBar(text = "Tuition Payments") }
    ){
            ...
            item{
                ...
                temp.forEach{ month ->
                    SelectCard(heading = month, onClick = {
                        navController.navigate("tuitionAdminApprove")
                        adminApprovePaymentViewModel.monthSelected.value = month
                        adminApprovePaymentViewModel.loadTuitionPayment()
                    })
